...
public class SearchStepDefinitions {
    ...
    public void iVerifyShippingAddress(Actor actor) {
        actor.has(Ensure.that(CheckOutShippingAddress.CONTACT).hasText(ShippingAddress.email));
        actor.has(Ensure.that(CheckOutShippingAddress.SHIP_TO).hasText(ShippingAddress.address + ", " + ShippingAddress.apartment + ", Singapore " + ShippingAddress.postalCode));
    }
}
